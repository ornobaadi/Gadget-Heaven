...
const GadgetDetail = () => {
    ...
    return (
        <div>
            <div>
                <div className="hero bg-[#9538E2] mt-5 py-10">
            ...
            <div className="hero bg-base-200 min-h-[800px]">
                <div className="hero-content flex-col lg:flex-row gap-16">
                    ...
                    <div>
                        ...
                        <p className="py-6 text-2xl font-bold">Price: $ {price}</p>
                        ...
                        <p className="py-3 text-lg font-bold">Specification: </p>
                        ...
                        <p className="py-2 text-lg font-bold">Rating</p>
                        ...
                        <div className="mt-10 flex gap-2">
                            <button className="btn rounded-full bg-[#9538E2] hover:text-black text-white">Add to cart
